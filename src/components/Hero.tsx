...
export function Hero(): JSX.Element {
  ...
  const canDownload = Boolean(selected && isDownloadReady(selected.href))
    ...
    <section className={styles.hero}>
      <div className={`layout ${styles.grid}`}>
        <div className={styles.copy}>
          ...
          >
            粘贴公开视频链接，选择清晰度，保存到本地。为 macOS 打造的极简下载工具。
          </motion.p>
        </div>
        ...
        >
          ...
          <div
            className={`${styles.split} ${!canDownload ? styles.splitDisabled : ''}`}
            ref={splitRef}
          >
            <button
              type="button"
            ...
            >
              ...
              <svg className={styles.chevron} viewBox="0 0 12 8" aria-hidden>
                <path
                  d="M1.2.8 6 5.6 10.8.8 12 2 6 8 0 2z"
                  fill="currentColor"
                />
              </svg>
            </button>
